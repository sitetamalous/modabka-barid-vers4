...
export const LoadingScreen = ({ 
  ...
  useEffect(() => {
    const loadingSteps = [
      { progress: 15, text: 'تحميل البيانات الأساسية...' },
      { progress: 35, text: 'إعداد واجهة المستخدم...' },
      { progress: 55, text: 'تحميل الامتحانات...' },
      { progress: 75, text: 'التحقق من الاتصال...' },
      { progress: 90, text: 'إعداد التطبيق...' },
  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-gradient-to-br from-emerald-50 via-white to-blue-50 flex flex-col items-center justify-center transition-opacity duration-300" dir="rtl">
