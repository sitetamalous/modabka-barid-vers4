...
export const DetailedAnswerReview = ({ attemptId }: DetailedAnswerReviewProps) => {
  ...
  if (!userAnswers || userAnswers.length === 0) {
    return (
      <div className="text-center py-10 px-3">
        ...
        <p className="text-gray-700 text-base">لا توجد تفاصيل متاحة لهذا الاختبار</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-4 px-2 max-w-full overflow-x-hidden text-base md:text-lg" dir="rtl">
      {/* الجزء الأول: ملخص الأداء */}
      <div className="p-3 bg-gradient-to-r from-emerald-50 to-blue-50 rounded-lg border-2 border-emerald-200 shadow-sm">
        {/* باقي المحتوى موجود بالفعل */}
      </div>

      {/* الجزء الثاني: قائمة الأسئلة */}
          ...
          return (
            ...
            >
              <div className="flex items-start justify-between gap-2">
                <div className={`flex items-center gap-2 flex-1 min-w-0 ${textColor} text-base`}>
                  {iconElement || <div className="w-4 h-4" />}
